            ...
            <div className="row mb-2">
                <div className="card col-md-3 card-1">
                    <div className="card-body">
                        ...
                        <a href="https://m.me/yassakocredit" className="btn btn-primary me-3" target="blank">Chat</a>
                ...
                <div className="card col-md-3 card-2">
                    <div className="card-body">
                        ...
                        <a href="https://my-dev-rating.herokuapp.com/login" className="btn btn-primary me-3 disabled" target="blank">View Site</a>
                ...
                <div className="card col-md-3 card-3">
                    <div className="card-body">
                        <h5 className="card-title">Ikiringo Website</h5>
                        <p className="card-text">Website for Ikiringo Africa culture hub.</p>
                        <h6 className="card-subtitle mb-2 text-muted">Wordpres, CSS</h6>
                        <a href="https://ikiringo.com/" className="btn btn-primary me-3 disabled" target="blank">View Site</a>
                    </div>
                </div>
            </div>
            <div className="row mb-2">
                <div className="card col-md-3 card-1">
                    <div className="card-body">
                        ...
                        <a href="https://my-dev-rating.herokuapp.com/login" className="btn btn-primary me-3" target="blank">View Site</a>
                ...
                <div className="card col-md-3 card-2">
                    <div className="card-body">
                        ...
                        <a href="https://dkabiswa.github.io/AutoMart/UI/login.html" className="btn btn-primary me-3" target="blank">View Site</a>
                ...
                <div className="card col-md-3 card-3">
                    <div className="card-body">
                        ...
                        <a href="https://my-dev-rating.herokuapp.com/login" className="btn btn-primary me-2 disabled" target="blank">Internal</a>
            ...
            <div className="row mb-2">
                <div className="card col-md-3 card-1">
                    <div className="card-body">
                        ...
                        <p className="card-text">A secure chat room web application that allows users to communicate with each other in real-time.</p>
                        <h6 className="card-subtitle mb-2 text-muted">React(Next), Chat Egine API, Railway</h6>
                        <a href="https://github.com/Dkabiswa/nextjs-chat" target="blank" className="btn btn-outline-primary"> Repo</a>
                    </div>
                </div>
                <div className="card col-md-3 card-2">
                    <div className="card-body">
                        <h5 className="card-title">Dream Solutions Website</h5>
                        <p className="card-text">A website for a local startup which deals in IT consulting and web development.</p>
                        <h6 className="card-subtitle mb-2 text-muted">HTML, JS, CSS</h6>
                        <a href="https://dkabiswa.github.io/dream-software/index.html" className="btn btn-primary me-3" target="blank">View Site</a>
                        <a href="https://github.com/Dkabiswa/dream-software" target="blank" className="btn btn-outline-primary"> Repo</a>
                    </div>
                </div>
            </div>
        </div>
